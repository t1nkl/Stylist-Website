<div id="modal">
    <div id="contacts" class="col-md-12 contact-form-block">
        ...
        <div class="contact-form">
            <form action="javascript:contact()" class="form-itself" id="contactform">
                ...
                <div class="contact-form4">
                    <textarea name="content" placeholder="Сообщение" id="content" cols="30" rows="10"></textarea>
                </div>
                <input type="submit" class="send-message-input" value="Отправить сообщение" >
            </form>
            <div class="contactform-message">
                <h2 class="contactform-response"></h2>
            </div>
        </div>
    </div>
</div>
